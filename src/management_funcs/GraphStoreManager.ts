...
import { existsSync, PathLike, PathOrFileDescriptor } from "fs";
...
export function addFileToStore(store: GraphStore, mkdir = false, ...fp: string[]): PathOrFileDescriptor | false{
...
export function addFolderToStore(store: GraphStore, mkdir = false, ...fp: string[]): PathOrFileDescriptor | false{
